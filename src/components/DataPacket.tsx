...
export const DataPacket: React.FC<DataPacketProps> = ({ start, end, speed, value = true }) => {
  ...
  const packetColor = value ? '#22d3ee' : '#ef4444';

  return (
    <circle r="3" fill={packetColor} className="animate-follow-path">
      <animateMotion 
        dur={duration} 
        repeatCount="1" 
        path={path} 
